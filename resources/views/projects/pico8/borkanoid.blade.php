...
<head>
  ...
  -->
  <title>Borkanoid</title>                                               <!-- <= WEBSITE TITLE -->
  <meta name="description" content="Pico-8 Arkanoid inspired game with added bork ">                    <!-- <= SITE DESCRIPTION as seen by web-search-engines -->
...
<div>
  ...
  <script async type="text/javascript" src="{{ asset('assets/borkanoid.js') }}"></script>       <!-- <= INCLUDES YOUR cart.js FILE -->
