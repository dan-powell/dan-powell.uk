...
@section('styles')
    ...
    <style type="text/css">
        .FungiHero {
            ...
            background-image: url("{!! app('image')->url('bg_inside.png') !!}"), url("{!! app('image')->url('bg_night.png') !!}");
...
@section('main')
    <section class="Section FungiHero">
        <div class="Section-container Section--center Section--md">
        	<div class="Content">
                <img alt="Fungi Falls" src="{!! app('image')->url('logo.png') !!}" width="645" height="333">
            </div>
     	</div>
    </section>
    ...
    <section class="Section Section--primary">
        <div class="Section-container Section--center Section--lg">
        	<div class="Content">
                <p><a class="Button" href="{{ url('assets/index.html') }}">Play Fungi Falls now on Desktop or Mobile</a></p>
        	</div>
     	</div>
    </section>
    <section class="Section Section--content">
        <div class="Section-container Section--xl">
            <div class="Content">
                ...
                <p><img alt="entity_shroom_red" src="{!! app('image')->url('entity_shroom_red.png') !!}"></p>
                <h3>But why?</h3>
                ...
                <p><img alt="entity_shroom_tan" src="{!! app('image')->url('entity_shroom_tan.png') !!}"></p>
    ...
    <section class="Section">
        <div class="Section-container Section--dark Section--center Section--xl">
        	<div class="Content">
                ...
                <p><a href="http://phaser.io" rel="nofollow" target="_blank"><img alt="Phaser Logo" src="{!! app('image')->url('Phaser-Logo-Small.png') !!}"></a></p>
                ...
                <h4>Open Source</h4>
                <p><a href="https://github.com/dan-powell/fungi-falls" rel="nofollow" target="_blank"><img alt="GitHub" src="{!! app('image')->url('GitHub-Mark-120px-plus.png') !!}"></a></p>
                <p>If anyone's interested, you can <a href="https://github.com/dan-powell/fungi-falls" rel="nofollow" target="_blank">find all the code and assets on GitHub</a>. This is my first foray in to game development, so the code is ropey at best, but feel free to use it in your own projects.</p>
        	</div>
     	</div>
    </section>
     <section class="Section">
        <div class="Section-container Section--content Section--xl Section--center">
        	<div class="Content">
                <p><img alt="player_gib_head" src="{!! app('image')->url('player_gib_head.png') !!}"></p>
                <h3>OK, cool beans.</h3>
                <p>No more questions? <a href="{{ url('assets/index.html') }}">You should check out the game then.</a></p>
                <hr><p><img alt="player_spritesheet" src="{!! app('image')->url('player_spritesheet.png') !!}"></p>
        	</div>
     	</div>
    </section>
@stop
