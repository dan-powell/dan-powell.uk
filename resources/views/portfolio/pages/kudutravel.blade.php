...
@section('main')
    ...
    <section class="Section  Section--primary Section--md Section--sidesOnly">
        <div class="Section-container ">
            <div class="Content">
                <img alt="New website design for Kudu Travel" class="Hero Hero--upperBorder" src="/projects/kudu-travel/hero.jpg">
            </div>
        </div>
    </section>
    ...
    <section class="Section  Section--dark Section--lg">
        <div class="Section-container ">
            <div class="Content">
                <div class="row">
                    <a class="col-sm-3" href="/img/projects/kudu-travel/initial-design-concept.jpg">
                        <img alt="Initial design concept" src="/img/projects/kudu-travel/initial-design-concept.jpg?w=600&amp;h=400&amp;fit=crop&amp;crop=top">
                    </a>
                    <p>
                        <a class="col-sm-3" href="/img/projects/kudu-travel/initial-design-concept.jpg">Initial design concept</a>
                    </p>
                    <a class="col-sm-3" href="/img/projects/kudu-travel/initial-design-concept.jpg"></a>
                    <a class="col-sm-3" href="/img/projects/kudu-travel/initial-typography.jpg">
                        <img alt="Initial typography styles" src="/img/projects/kudu-travel/initial-typography.jpg?w=600&amp;h=400&amp;fit=crop&amp;crop=top">
                    </a>
                    <p><a class="col-sm-3" href="/img/projects/kudu-travel/initial-typography.jpg">Initial typography styles</a></p><a class="col-sm-3" href="/img/projects/kudu-travel/initial-typography.jpg">
                    </a>
                </div>
    ...
    <section class="Section  Section--primary Section--center Section--md Section--sidesOnly">
        <div class="Section-container ">
            <div class="Content">
                <div class="row">
                    <div class="col-sm-2">
                        <img alt="Mobile version example - tour page header" class="Hero Hero--upperBorder Hero--upperBorder--sm" src="/projects/kudu-travel/mobile1.jpg">
                    </div>
                    <div class="col-sm-2">
                        <img alt="Mobile version example - tour page content" class="Hero Hero--upperBorder Hero--upperBorder--sm" src="/projects/kudu-travel/mobile2.jpg">
                    </div>
                    <div class="col-sm-2">
                        <img alt="Mobile version example - tour page additional information" class="Hero Hero--upperBorder Hero--upperBorder--sm" src="/projects/kudu-travel/mobile3.jpg">
                    </div>
                </div>
            </div>
        </div>
